var oddsportal = require('core/oddsportal.js');
...
casper.start("https://www.oddsportal.com/matches/soccer", function(){
    oddsportal.executeScrape(casper, curDate.split('-').join(''), countryList, function(data){
