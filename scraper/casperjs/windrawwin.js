var windrawwin = require('core/windrawwin.js');
...
casper.start("https://www.windrawwin.com/predictions/", function(){
    windrawwin.executeScrape(casper, curDate, countryList, function(data){
